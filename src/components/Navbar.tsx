    ...
    <>
      ...
      <div className="fixed top-6 right-6 z-[60] flex items-center gap-3">
        ...
        <motion.a
          ...
          whileTap={{ scale: 0.95 }}
          className="hidden sm:flex bg-primary text-white px-6 py-3 rounded-full font-black text-sm uppercase tracking-wide shadow-lg shadow-primary/20 items-center gap-2"
        >
