    ...
    return (
        <section className="relative min-h-[50vh] md:min-h-[90vh] flex flex-col items-center justify-center text-center px-4 md:px-12 overflow-hidden py-10 md:py-20">
            ...
            >
                ...
                <a
                    href="#services"
                    className="bg-white/90 text-black hover:bg-white px-8 py-4 rounded-xl font-bold transition-all hover:scale-[1.02] active:scale-[0.98] text-lg border border-white/50 backdrop-blur-md shadow-lg cursor-pointer"
                >
                    View Services
                </a>
            </motion.div>
