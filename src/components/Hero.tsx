    ...
    return (
        <section className="relative min-h-[90vh] flex flex-col items-center justify-center text-center px-6 md:px-12 overflow-hidden py-20 bg-background">
            ...
            <motion.div
                ...
                className="inline-flex items-center gap-2 px-5 py-2 rounded-full bg-slate-50 border border-slate-200 text-primary text-sm font-black mb-10 shadow-md"
            >
            ...
            {/* Trust Indicators - High Visibility */}
            <div className="mt-20 flex flex-wrap justify-center gap-8 opacity-100 transition-all duration-500">
                <div className="flex items-center gap-2 font-black text-sm text-slate-600">
