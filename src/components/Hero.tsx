...
const Hero = () => {
    return (
        <section className="relative min-h-[90vh] flex flex-col items-center justify-center text-center px-6 md:px-12 overflow-hidden py-20">
            ...
            >
                <a href="#contact" className="group bg-[#1DB4A1] text-white px-8 py-4 rounded-xl font-bold transition-all shadow-[0_0_20px_rgba(29,180,161,0.3)] hover:shadow-[0_0_30px_rgba(29,180,161,0.5)] hover:scale-[1.02] active:scale-[0.98] flex items-center justify-center gap-3 text-lg border border-[#1DB4A1]">
                    Book Appointment
